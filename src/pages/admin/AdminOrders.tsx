...
const AdminOrders = () => {
  ...
  const [receipt, setReceipt] = useState<any>({ shop_name: 'STOPY SHOES', tagline: "Pakistan's #1 Shoes & Bags Store", contact_line: '', footer_line: 'Thank you!', website: 'www.stopyshoes.pk' });
