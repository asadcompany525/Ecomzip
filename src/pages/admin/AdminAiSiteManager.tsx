...
Reply in English or Roman Urdu.` },
      ...
      setMessages(prev => [...prev, { role: 'assistant', content: cleanReply || '✅ Setting updated!' }]);
    } catch (e: any) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">Change any website setting with AI — store name, policies, fees, contact info, etc.</p>
      ...
      <div className="bg-card border rounded-xl min-h-[300px] max-h-[400px] overflow-y-auto p-4 space-y-3">
        {messages.length === 0 && (
